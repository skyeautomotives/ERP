  ...
  return (
    <div>
      ...
      <div className="flex items-center gap-2">
        <h1 className="text-lg font-semibold text-gray-900 dark:text-gray-100">Credit Collection Within 90 Days</h1>
        <HelpButton content={HELP_CONTENT["collection-report"]} />
      </div>
      <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
        Every payment collected against a credit sale in this period, and how many days it took from invoice to
        collection.
      </p>
        ...
        <table className="w-full text-left text-sm">
          <thead className="border-b border-gray-200 dark:border-gray-800 bg-gray-50 dark:bg-gray-950 text-xs uppercase text-gray-500 dark:text-gray-400">
            <tr>
              ...
              <th className="px-4 py-2 font-medium">Invoice amount</th>
          ...
          <tbody className="divide-y divide-gray-100 dark:divide-gray-800">
            {rows.map((r, i) => (
              <tr key={i}>
                ...
                <td className="px-4 py-2 text-gray-900 dark:text-gray-100">{Number(r.invoice_amount).toFixed(2)}</td>
                <td className="px-4 py-2 text-gray-500 dark:text-gray-400">{r.due_date ?? "-"}</td>
