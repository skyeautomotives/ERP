...
export default async function NewCashSalePage() {
  ...
  return (
    <div>
      <div className="flex items-center gap-2">
        <h1 className="text-lg font-semibold text-gray-900 dark:text-gray-100">New cash sale</h1>
        <HelpButton content={HELP_CONTENT["cash-sales"]} />
      </div>
